                ...
                <div key={rowIdx} className="mb-3 overflow-hidden">
                  <div className={`flex gap-3 ${isEvenRow ? 'animate-scroll-left' : 'animate-scroll-right'}`}>
                    ...
                    {[...rowItems, ...rowItems].map((t, idx) => {
                      ...
                      const content = (
                        <div className="relative group h-full rounded-lg border border-white/10 bg-surface hover:border-accent/40 hover:shadow-lg hover:shadow-accent/10 transition-all duration-300 overflow-hidden flex-shrink-0 w-[200px]">
                          {/* Rank badge for top 3 */}
                          {rankEmoji && (
                            ...
                            <div className="flex items-center gap-2 mb-2">
                              <div className="flex-shrink-0 relative">
                                {logo ? (
                                  ...
                                  <div className="w-8 h-8 rounded-full bg-gradient-to-br from-accent/20 to-accent-dark/20 flex items-center justify-center text-sm font-bold ring-1 ring-white/10">
                                    {symbol ? symbol[0] : '?'}
                                  </div>
                                )}
                              </div>
